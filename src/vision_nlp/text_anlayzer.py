"""
text_analyzer.py — dataDoctor v0.6.0
======================================
...
class SentimentAnalyzer:
    ...
    def _lexicon_score(self, sents: list[str]) -> list[dict]:
        ...
        POS = {"good","great","excellent","wonderful","amazing","love","happy",
               "positive","beautiful","perfect","fantastic","best","nice","joy"}
        NEG = {"bad","terrible","awful","horrible","hate","sad","negative","ugly",
